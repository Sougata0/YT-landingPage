    ...
    return(
        <div className="flex items-center gap-3 w-full max-w-160">
            <div className="flex items-center w-full">
                <input className=" rounded-l-full bg-transparent px-3  py-2 border-neutral-700 border-r-0 border w-full outline-none text-sm text-neutral-200" placeholder="Search" type="text"/>
